...
namespace TanCruzDentalInventorySystem.BusinessService
{
		public class ItemService : IItemService
		{
				...
				public async Task<IEnumerable<ItemSearchFormViewModel>> GetItemSearchModalList()
				{
						var itemSearchModalList = await _itemRepository.GetItemSearchModalList();
						return Mapper.Map<List<ItemSearchFormViewModel>>(itemSearchModalList);
				}
